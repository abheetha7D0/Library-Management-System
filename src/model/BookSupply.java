...
public class BookSupply {
    ...
    public BookSupply(String supplyId, String supplyDate, String supplierId, double supplyCost) {
    ...
    public BookSupply(String supplyId, String supplyDate, String supplierId, double supplyCost, ArrayList<BookSupplyDetail> books) {
